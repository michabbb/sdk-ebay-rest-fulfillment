...
class GiftDetails implements ModelInterface, ArrayAccess
{
     ...
     * Sets recipientEmail
     *
     * @param string|null $recipientEmail The email address of the gift recipient. The seller will send the digital gift card to this email address.
     *
     * @return $this
     */
     ...
     * Sets senderName
     *
     * @param string|null $senderName The name of the buyer, which will appear on the email that is sent to the gift recipient.
     *
     * @return $this
     */
