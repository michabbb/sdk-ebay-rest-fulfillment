...
class PaymentDisputeApi
{
    ...
    protected function fetchEvidenceContentRequest($paymentDisputeId, $evidenceId, $fileId)
    {
        ...
        // query params
        if ($evidenceId !== null) {
            $queryParams['evidence_id'] = ObjectSerializer::toQueryValue($evidenceId);
        }
        // query params
        if ($fileId !== null) {
    ...
    protected function getPaymentDisputeSummariesRequest($orderId = null, $buyerUsername = null, $openDateFrom = null, $openDateTo = null, $paymentDisputeStatus = null, $limit = null, $offset = null)
    {
        ...
        // query params
        if ($orderId !== null) {
            $queryParams['order_id'] = ObjectSerializer::toQueryValue($orderId);
        }
        // query params
        if ($buyerUsername !== null) {
            $queryParams['buyer_username'] = ObjectSerializer::toQueryValue($buyerUsername);
        }
        // query params
        if ($openDateFrom !== null) {
            $queryParams['open_date_from'] = ObjectSerializer::toQueryValue($openDateFrom);
        }
        // query params
        if ($openDateTo !== null) {
            $queryParams['open_date_to'] = ObjectSerializer::toQueryValue($openDateTo);
        }
        // query params
        if ($paymentDisputeStatus !== null) {
            $queryParams['payment_dispute_status'] = ObjectSerializer::toQueryValue($paymentDisputeStatus);
        }
        // query params
        if ($limit !== null) {
